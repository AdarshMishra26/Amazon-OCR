...
download_folder = 'downloaded_images2'
...
async def process_images_from_csv(input_csv, output_csv):
    ...
    image_urls = df['images_url'].head(100).tolist()  # Process first 5000 images
    ...
    for i in range(len(image_urls)):
        ...
        print(f"Processing image {i+1}/{len(image_urls)}: {image_path}")  # Show which file is being processed
